              ...
              console.log(touriffyDotComPrice);
                  ...
                  ************************************************************************************/
                      ...
                      document.write('<h3>  Find best hotel deals in Bangladesh</h3>');
                       var f='<form><input type="text" style="position:absolute;left:10px;top:100px; width: 280px;padding: 20px 20px; margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;background-color: MintCream  ;" id="myText" placeholder="Where are you going?"> <br>  <input type="date" style="position:absolute;left:10px;top:200px; width: 280;padding: 20px 20px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;background-color: MintCream  ;" id="check-in" value="<?php echo date('Y-m-d'); ?>"></input> <br> <input type="date" style="position:absolute;left:10px;top:300px; width: 280;padding: 20px 20px; margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;background-color: MintCream  ;" id="check-out" value="<?php echo date('Y-m-d', strtotime(' +1 day')); ?>"></input> <br> <input type="submit" onclick="destinationValidation()" style="position:absolute;left:10px; top:400px;width: 280px;background-color: Turquoise;padding: 20px 20px;margin: 8px 0;border: none;border-radius: 4px;cursor: pointer;"></button></form></div>';
...
<body onload="sessionCheck()">
  ...
  <div  style="width: 100%; position:absolute; top: 180px; left:200px; ">
        ...
        <form method="post" action="Search.php" id="F">
           ...
           <input type="text" id="myText" name="city" placeholder="Where are you going?">
