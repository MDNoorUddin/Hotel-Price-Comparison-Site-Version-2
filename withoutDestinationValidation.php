...
****************************************************************************************************/
            ...
            //alert("location : " + results[0].geometry.location.lat() + " " +results[0].geometry.location.lng()); 
                      ...
                      myMap();
                       ...
                       document.write('<input type="checkbox" id="1" value="999" onclick="box1()">0 - 1000 BDT<br><input type="checkbox" id="2" value="2499"  onclick="box2()">0 - 2500 BDT <br><input type="checkbox" id="3" value="5000" onclick="box3()">0 - 5000 BDT<br><input type="checkbox" id="4" value="10000" onclick="box4()">0 - 10000 BDT <br><br>');
                       if(priceLimit>5000)
                       {
