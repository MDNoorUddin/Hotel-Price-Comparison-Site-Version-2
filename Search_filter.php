...
****************************************************************************************************/
            ...
            //alert("location : " + results[0].geometry.location.lat() + " " +results[0].geometry.location.lng()); 
                      ...
                      myMap();
                       ...
                       document.write('<input type="checkbox" name="vehicle1" value="999">0 - 1000 BDT<br><input type="checkbox" name="vehicle2" value="2499">0 - 2500 BDT <br><input type="checkbox" name="vehicle1" value="5000">0 - 5000 BDT<br><input type="checkbox" name="vehicle2" value="10000">0 - 10000 BDT <br><br>');
