...
<html>
<head>
  <title>cheapest Hotels in Bangldesh</title>
  
</head>
<body>
     <a href="index.php" style="color: white;font-size: 15px; position:absolute; left: 1200px;top: 15px;">login</a><a href="index.php" style="color: white;font-size: 15px; position:absolute; left: 1200px;top: 40px;">Register</a></body>
</html><!DOCTYPE html>
<html  lang="en-US">
<head>
...
<script type="text/javascript">
 ...
 /**********************************************************************************************/                           //Setting Static destination names for validatig form
          ...
          validation.add("darjeeling");
          validation.add("Pabna");
          validation.add("pabna");
          validation.add("Dubai");
          validation.add("dubai");
          validation.add("Khulna");
          validation.add("khulna");
          validation.add("Barishal");
          validation.add("barishal");
...
/***********************************************************************************************/
    ...
    function kuakata()
    {
        ...
        check_in_date = "2018-07-06";
        
        check_out_date = "2018-07-07";
        search();
    }
...
/******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************* This is the main searching function**********************************************************************/            
            ...
            catch(e)
            {
              ...
              else if(city=="Pabna"||city=="pabna")
              {
                  ...
                  touriffy_com_URL = "http://touriffy.com/index.php/hotel/hotelsearch/Pabna/all/"+y1+"-"+m1+"-" +d1+"/"+y1+"-"+m1+"-"+d2+"/score_desc/USD/pricepernight-/stars-/facility-/10";

                  tripadvisor_com_URL = "https://www.tripadvisor.com/Hotels-g668000-Pabna_Rajshahi_Division-Hotels.html";

                  booking_dot_com_URL = "x.com";
              }

              else if(city=="khulna"||city=="Khulna")
              {

                  hotels_com_URL = "https://www.hotels.com/search.do?resolved-location=CITY%3A91227%3AUNKNOWN%3AUNKNOWN&destination-id=91227&q-destination=Khulna,%20Bangladesh&q-check-in="+y1+"-"+m1+"-"+d1+"&q-check-out="+y1+"-"+m2+"-"+d2+"&q-rooms=1&q-room-0-adults=2&q-room-0-children=0";
                  ...
                  touriffy_com_URL = "http://touriffy.com/index.php/hotel/hotelsearch/Khulna/all/"+y1+"-"+m1+"-" +d1+"/"+y1+"-"+m1+"-"+d2+"/score_desc/USD/pricepernight-/stars-/facility-/10";

                  tripadvisor_com_URL = "https://www.tripadvisor.com/Hotels-g667472-Khulna_City_Khulna_Division-Hotels.html";

                  booking_dot_com_URL = "x.com";
              }

               else if(city=="Barishal"||city=="barishal")
              {

                  hotels_com_URL = "https://www.hotels.com/search.do?resolved-location=CITY%3A82208%3AUNKNOWN%3AUNKNOWN&destination-id=82208&q-destination=Barisal,%20Bangladesh&q-check-in="+y1+"-"+m1+"-"+d1+"&q-check-out="+y1+"-"+m2+"-"+d2+"&q-rooms=1&q-room-0-adults=2&q-room-0-children=0";
                  ...
                  touriffy_com_URL = "http://touriffy.com/index.php/hotel/hotelsearch/Barishal/all/"+y1+"-"+m1+"-" +d1+"/"+y1+"-"+m1+"-"+d2+"/score_desc/USD/pricepernight-/stars-/facility-/10";

                  tripadvisor_com_URL = "https://www.tripadvisor.com/Hotels-g667461-Barisal_City_Barisal_Division-Hotels.html";
              ...
              console.log(touriffyDotComPrice);
                  ...
                  ************************************************************************************/
                      ...
                      document.write('<select id="myInput" name="city" style="position:absolute;left:10px;top:100px; width: 280px;padding: 20px 20px; margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;background-color: MintCream  ;">');
                        ...
                        document.write('<option value="none">Where are you going?</option><option value="sylhet">Sylhet</option><option value="dhaka">Dhaka</option><option value="bandarban">Bandarban</option><option value="kuakata">Kuakata</option><option value="Cox Bazar">Coxs Bazar</option><option value="Chittagong">Chittagong</option><option value="Rangamati">Rangamati</option><option value="Saint Martin">Saint Martin</option><option value="Barishal">Barishal</option><option value="Pabna">Pabna</option><option value="Khulna">Khulna</option><option value="Paris">Paris</option><option value="Las Vegas">Las Vegas</option><option value="Dubai">Dubai</option><option value="Goa">Goa</option><option value="Darjeeling">Darjeeling</option><option value="Cairo">Cairo</option></option></select>');

                        document.write('<input type="date" style="position:absolute;left:10px;top:200px; width: 280;padding: 20px 20px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;background-color: MintCream  ;" id="check-in" value="2018-07-06" min="2018-07-06"></input> <br> <input type="date" style="position:absolute;left:10px;top:300px; width: 280;padding: 20px 20px; margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;background-color: MintCream  ;" id="check-out" value="2018-07-07" min="2018-07-06"></input> <br> <input type="submit" onclick="destinationValidation()" style="position:absolute;left:10px; top:400px;width: 280px;background-color: Turquoise;padding: 20px 20px;margin: 8px 0;border: none;border-radius: 4px;cursor: pointer;"></button></form></div>');
...
<body onload="sessionCheck()">
  ...
  <div  style="width: 100%; position:absolute; top: 180px; left:200px; ">
        ...
        <form  method="post" action="Search.php" id="F">
           ...
           <input type="date" id="check-in" value="2018-07-06" min="2018-07-06"></input>

           <input type="date" id="check-out" value="2018-07-07" min="2018-07-06"></input>
